...
- issues occur due to React magic involving mounting and unmounting
- You can add a 'key' to the <li> element. You want to do this anytime you're dynamically rendering an array
- Using an item's index as the key isn't good enough. You want a unique key. Id is good usually.
- In particular you see array rendering issue when the items maintain some kind of state
- Does this imply everything has an id even if you don't set it? I assume so.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=chris.g.peabody%40gmail.com).
